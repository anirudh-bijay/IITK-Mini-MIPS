...
#
# Generated by Vivado on Wed Apr 09 03:26:04 +0530 2025
...
set_msg_config  -id {17-179}  -suppress  -ruleid {38}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {4}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {40}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {44}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {5}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {54}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {55}  -source -1
set_msg_config  -id {17-179}  -suppress  -ruleid {57}  -source -1
